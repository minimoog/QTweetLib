...
#ifndef QTWEETRETWEETBYUSER_H
#define QTWEETRETWEETBYUSER_H

#include "qtweetnetbase.h"

/**
 *  Returns most recent retweets posted by the specified user.
 */
class QTWEETLIBSHARED_EXPORT QTweetRetweetByUser : public QTweetNetBase
{
    Q_OBJECT
...
public:
    explicit QTweetRetweetByUser(QObject *parent = 0);
    QTweetRetweetByUser(OAuthTwitter *oauthTwitter, QObject *parent = 0);
